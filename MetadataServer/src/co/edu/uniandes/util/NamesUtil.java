...
public class NamesUtil {
	 ...
	 * @return String It is the answer sent by the name server.
	 */
	public static String nameInitialTime(int clientId, String nameServer, int port) {
		// a: answer; r: reader; w: writer
		String a = "";
	 ...
	 * @return String It is the answer sent by the name server.
	 */
	public static String nameEndTime(int clientId, String nameServer, int port) {
		// a: answer; r: reader; w: writer
		String a = "";
	 ...
	 * @return String It is the answer sent by the name server.
	 */
	public static String nameServerQueryTime(String nameServer, int port) {
		// a: answer; r: reader; w: writer
		String a = "";
