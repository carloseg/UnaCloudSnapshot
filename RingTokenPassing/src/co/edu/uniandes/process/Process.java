...
//		fileFlag = new File(configuration.getPathFileFlag()+"testFinished.txt");
		// Si el archivo exite, indica que la ejecución terminó. Por eso, al iniciar lo
		// elimina.
...
//					/////// Crea un archivo para indicar que terminó
